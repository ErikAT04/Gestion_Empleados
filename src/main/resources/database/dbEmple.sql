...
INSERT INTO ENTERPRISE(enter_name, enter_passwd) VALUES ("FiberTec", SHA2("FibTec1234", 256));
...
INSERT INTO EMPLE(dni, working_dept, emp_name, emp_surname, emp_salary, emp_date_join) VALUES ("12345678K", (SELECT ID FROM DEPT WHERE DEPT_LOCATION LIKE "Murcia" AND DEPT_NAME LIKE "Saldos" AND ENTERPRISE = (SELECT id from ENTERPRISE where enter_name like "FiberTec")), "Pedro", "López Vega", 1080, STR_TO_DATE("20-04-2020", "%d-%m-%Y"));
